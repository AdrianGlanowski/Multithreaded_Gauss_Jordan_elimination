...
public class GaussJordanElimination {
    ...
    public final void solve(double[][] matrix){
        ...
        for (int sourceRow=0; sourceRow<matrix.length; ++sourceRow){
            List<Runnable> A_tasks = new ArrayList<>(List.of());
            List<Runnable> B_tasks = new ArrayList<>(List.of());
            List<Runnable> C_tasks = new ArrayList<>(List.of());
        ...
        //D
        List<Runnable> D_tasks = new ArrayList<>(List.of());
        ...
        //E
        List<Runnable> E_tasks = new ArrayList<>(List.of());
        for (int row=0; row<matrix.length; ++row) {
